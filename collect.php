...
// 貼文資訊
$selectPostJoinUser = "SELECT Users.username, Posts.postID, Posts.title, Posts.createdAt FROM Posts
JOIN Users ON Users.userID = Posts.userID
WHERE Posts.postID IN (
	SELECT postID FROM Collections WHERE Collections.userID = ?
);";
...
$posts = sqlsrv_query($conn, $selectPostJoinUser, $params);
